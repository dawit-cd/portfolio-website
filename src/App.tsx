...
function SkillIcon({ skill }: { skill: string }) {
  const baseClass = "h-3.5 w-3.5 transition-transform duration-300 ease-out group-hover:scale-125";
  const name = skill.toLowerCase();

  if (name.includes('react')) {
    return (
      <svg className={`${baseClass} group-hover:animate-[spin_4s_linear_infinite] text-[#61dafb]`} viewBox="0 0 100 100" fill="currentColor">
  ...
  if (name.includes('typescript')) {
    return (
      <svg className={`${baseClass} group-hover:-translate-y-0.5 text-[#3178c6] rounded-[2px]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (name.includes('tailwind')) {
    return (
      <svg className={`${baseClass} group-hover:animate-pulse text-[#38bdf8]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (name.includes('next.js') || name.includes('nextjs')) {
    return (
      <svg className={`${baseClass} bg-white text-black rounded-full border border-white`} viewBox="0 0 180 180" fill="currentColor">
  ...
  if (name.includes('node')) {
    return (
      <svg className={`${baseClass} group-hover:animate-bounce text-[#339933]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (name.includes('nest')) {
    return (
      <svg className={`${baseClass} group-hover:rotate-12 text-[#e0234e]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (name.includes('postgres')) {
    return (
      <svg className={`${baseClass} text-[#336791]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  if (name.includes('mongo')) {
    return (
      <svg className={`${baseClass} group-hover:scale-110 text-[#47a248]`} viewBox="0 0 24 24" fill="currentColor">
  ...
  return <Code className={`${baseClass} text-slate-400 group-hover:text-teal-400`} />;
}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#11161f] text-slate-200 font-sans antialiased selection:bg-teal-500 selection:text-slate-950 pb-16">
      ...
      </header>      {/* CORE WORKSPACE CONTAINER */}
